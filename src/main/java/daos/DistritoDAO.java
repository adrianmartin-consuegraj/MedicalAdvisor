...
import daos.interfaces.IDistritoDAO;
import domain.Cita;
...
//	public Distrito recuperarDistritoPorUsuario(Distrito distrito) throws DAOException {
//		
//		PreparedStatement st = null;
//		ResultSet rs = null ;
//		//Distrito distritoRecuperado = new Distrito();
//		
//			try {
//				st = con.prepareStatement(DbQuery.getRecuperarDistritoPorUsuario());
//				st.setInt(1, distrito.getNumero());
//				rs=st.executeQuery();
//				if (rs.next()){
//	
//					distrito = new Distrito(rs.getInt(1),
//							        rs.getString(2)); 
//					
//				}
//				
...
//	}
	...
	public Distrito recuperarDistrito(Distrito ubicacion) throws DAOException {
		...
		ResultSet rs = null ;
			...
			try {
				...
				st = con.prepareStatement(DbQuery.getRecuperarDistrito());
				st.setInt(1, ubicacion.getNumero());
				rs=st.executeQuery();
				
				if (rs.next()){
	
					ubicacion = new Distrito(rs.getInt(1), rs.getString(2), rs.getInt(3), rs.getString(4), rs.getString(5), rs.getString(6)); 
