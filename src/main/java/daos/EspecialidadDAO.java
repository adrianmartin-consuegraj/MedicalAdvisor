...
import daos.interfaces.IEspecialidadDAO;
...
public class EspecialidadDAO implements IEspecialidadDAO {
	...
	@Override
	public void añadirEspecialidad(int centro, String especialidad) throws DAOException {
	...
	public List<Especialidad> recuperarEspecialidadesPorIdCentro(int idCentro) throws DAOException {
		...
		List<Especialidad> especialidades = new ArrayList<Especialidad>();
			...
			try {
				st = con.prepareStatement(DbQuery.getRecuperarEspecialidadesPorIdCentro());
				st.setInt(1, idCentro);
				rs=st.executeQuery();
				
				while (rs.next()){
	
					especialidad = new Especialidad(rs.getString(1)); 
...
//	
//	@Override
//	public void añadirCita(String usuario, String centro, Date fecha) throws DAOException {
//		
//		PreparedStatement st = null;
