...
public class CentroDAO implements ICentroDAO {
	...
	public CentroDAO(Connection con) {
		this.con = con;
	}
...
//	public void ActualizarPuntuacionCentro(int idCentro, String usuario, int puntuacion) throws DAOException {
//
//		PreparedStatement st = null;
//		ResultSet rs = null;
//
//		try {
// 
//			st = con.prepareStatement(DbQuery.getActualizarPuntuacionCentro());
//			st.setInt(1, puntuacion);
//			st.setInt(2, idCentro);
//			st.setString(3, usuario);
//			System.out.println("DAO 2 FINAL aa");
//			
//			st.executeQuery();
//			System.out.println("DAO 2 FINAL bb");
//		} catch (SQLException e) {
//			throw new DAOException(DB_ERR, e);
//		} finally {
//			Recursos.closeResultSet(rs);
//			Recursos.closePreparedStatement(st);
//		}
//		System.out.println("sisas 2");
//	}
	
	
	
//	public void ModificarPuntuacionCentro(int idCentro, int puntuacion, String usuario) throws DAOException {
//
//		PreparedStatement st = null;
//		ResultSet rs = null;
//		System.out.println("DAO 1 FINAL");
//		System.out.println("idCentro: " + idCentro);
//		System.out.println("Puntuacion: " + puntuacion);
//
//		try {
//
//			st = con.prepareStatement(DbQuery.getModificarPuntuacionCentro());
...
//			st.executeQuery();
//
//			System.out.println("DAO 2 FINAL ee");
//		} catch (SQLException e) {
//			throw new DAOException(DB_ERR, e);
//		} finally {
//			Recursos.closeResultSet(rs);
...
//	}
	...
	public void ModificarPuntuacionCentro(int idCentro, int puntuacion) throws DAOException {
