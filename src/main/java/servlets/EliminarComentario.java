...
public class EliminarComentario extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//0~Recuperamos los datos de la cita a añadir (Usuario, Fecha y Mensaje) introducidos por el form en PerfilCentro.jsp
		String id = request.getParameter("centro");
		...
		try {
			System.out.println("ENTRA POR AQUI -e");
			
			//Eliminamos el comentario
			sComentario.EliminarComentario(idCentro, nombreUsuario, fecha, mensaje);
			
			System.out.println("SALE POR AQUI -e");
