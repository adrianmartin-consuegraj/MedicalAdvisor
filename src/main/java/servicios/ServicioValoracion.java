...
public class ServicioValoracion {
	...
	//1. Recuperamos las Valoraciones de los Centros - VALORACIONES table
	public List<Valoracion> RecuperarValoracion() throws ServiceException {
		...
		try {
			...
			trans = new TransaccionesManager();
			ValoracionDAO valoracionDAO = trans.getValoracionDAO();

			valoraciones = valoracionDAO.recuperarValoracionRegistrada();
	...
	//2a. Actualizamos la Valoración en la tabla "valoraciones" - VALORACIONES table (modificación de una valoración existente asociada a un usuario y un centro)
	public void ActualizarValoracion(int idCentro, String usuario, int puntuacion) throws ServiceException {
		...
		try {
			...
			valoracionDAO.ActualizarValoracion(idCentro, usuario, puntuacion);
	...
	//2b. Insertamos la Valoración en la tabla "valoraciones" - VALORACIONES table (nueva valoración asociada a un usuario y un centro)
	public void InsertarValoracion (int idCentro, String usuario, int puntuacion) throws ServiceException {
		...
		try {
			...
			valoracionDAO = trans.getValoracionDAO();
			valoracionDAO.InsertarValoracion(idCentro, usuario, puntuacion);
