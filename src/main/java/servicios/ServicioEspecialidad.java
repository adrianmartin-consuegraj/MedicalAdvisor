...
//	}
	...
	public List<Especialidad> RecuperarEspecialidadesPorIdCentro(int idCentro) throws ServiceException {
		...
		try {
			...
			trans = new TransaccionesManager();
			EspecialidadDAO especialidadDAO = trans.getEspecialidadDAO();
		
			especialidades = especialidadDAO.recuperarEspecialidadesPorIdCentro(idCentro);
