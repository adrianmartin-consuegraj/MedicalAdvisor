...
public class ServicioDistrito {
	...
	public ServicioDistrito() {
	}
	
	
	
//	public void insertarCita(Cita cita) throws ServiceException{
//		
...
//	public Distrito RecuperarDistrito(Distrito distrito) throws ServiceException {
//		
//		TransaccionesManager trans = null;
//		Distrito distritoRecuperado = null;
//
//		try {
//			
//			trans = new TransaccionesManager();
//			DistritoDAO distritoDAO = trans.getDistritoDAO();
//			
//			distritoRecuperado = distritoDAO.recuperarDistritoPorUsuario(distrito);
//            
//			trans.closeCommit();
//            
//		} catch (DAOException e) {
...
//
//		}
//		return distritoRecuperado;
//	}



	public Distrito RecuperarDistrito(Distrito ubicacion) throws ServiceException {
		...
		try {
			...
			ubicacion = distritoDAO.recuperarDistrito(ubicacion);
