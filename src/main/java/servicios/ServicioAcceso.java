...
//	}
	...
	public Acceso RecuperarAccesoPorIdCentro(int idCentro) throws ServiceException {
		...
		try {
			...
			trans = new TransaccionesManager();
			AccesoDAO accesoDAO = trans.getAccesoDAO();
			
		
			accesos = accesoDAO.recuperarAccesoPorIdCentro(idCentro);
