...
//	}
	...
	public List<Comentario> RecuperarComentariosPorIdCentro(int idCentro) throws ServiceException {
		...
		try {
			...
			comentarios = comentarioDAO.recuperarComentariosPorIdCentro(idCentro);
	...
	public void añadirComentario(int idCentro, String nombreUsuario, Date fecha, String mensaje) throws ServiceException {
		...
		try {
			...
			trans =  new TransaccionesManager();;
			comentarioDAO = trans.getComentarioDAO();
			comentarioDAO.añadirComentario(idCentro, nombreUsuario, fecha, mensaje);
	...
	public void EliminarComentario(int idCentro, String nombreUsuario, Date fecha, String mensaje) throws ServiceException {
		...
		try {
			...
			trans =  new TransaccionesManager();;
			comentarioDAO = trans.getComentarioDAO();
			comentarioDAO.eliminarComentario(idCentro, nombreUsuario, fecha, mensaje);
